...
input_frame = Frame(window, width=321, height=50)
...
buton_clear = Button(frame_butoane, text='C', width=38, height=3, bg='#eee', cursor='hand2',
...
minus = Button(frame_butoane, text='-', width=10, height=3, bg='#eee', cursor='hand2', command=lambda: click('-')).grid(
    row=2, column=3)
...
noua = Button(frame_butoane, text='9', width=10, height=3, bg='#eee', cursor='hand2', command=lambda: click('9')).grid(
    row=1, column=2)
inmultire = Button(frame_butoane, text='*', width=10, height=3, bg='#eee', cursor='hand2',
...
trei = Button(frame_butoane, text='3', width=10, height=3, bg='#eee', cursor='hand2', command=lambda: click('3')).grid(
    row=3, column=2)
plus = Button(frame_butoane, text='+', width=10, height=3, bg='#eee', cursor='hand2',
...
zero = Button(frame_butoane, text='0', width=10, height=3, bg='#eee', cursor='hand2', command=lambda: click('0')).grid(
    row=4, column=0)
rerozero = Button(frame_butoane, text='00', width=10, height=3, bg='#eee', cursor='hand2', command=lambda: click('00')).grid(
    row=4, column=1)
